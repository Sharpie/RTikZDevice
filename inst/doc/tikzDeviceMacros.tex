...
% Temporary re-definition of Sweave's Schunk environment. Basically a
% stripped-down version of the tikzCodeBlock code. The code here overwrites
% \begin{Schunk} and \end{Schunk}
\makeatletter
\def\Schunk{%
  \begingroup%
    \@bsphack%
