...
% Sigh... I hate having 50,000 copies of this environment..
% but for some $&%^ing reason listings won't take a macro
% as an argument to style=
\makeatletter 
\newwrite\lstvrb@out 
\newenvironment{tikzShellExample}[1][]{% 
  ...
  \begin{tikzpicture}
  	\node[code body,codebody color=white] (code node body) {
	    \lstinputlisting[style = bashSource]{\jobname.lst}%
	 };
