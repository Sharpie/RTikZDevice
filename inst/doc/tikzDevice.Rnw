...
\date{Version \tikzDeviceVersion\qquad February, 2010}
...
During the beta period the actual implementation of the package may differ significantly from what is described in this documentation.\\[1em]
